...
│                     PC (Windows / Linux)                         │
│                                                                  │
│  FP16 Base Model (TinyLlama 1.1B)                               │
│       │                                                          │
│       ├── Domain Corpus (general / code / chat)                  │
│       │         │                                                │
│       │    llama-imatrix ──► Importance Matrix (.gguf)           │
│       │         │                                                │
│       └── llama-quantize ──► 6 Quantized Models                 │
│            general-Q5/Q3 │ code-Q5/Q3 │ chat-Q5/Q3              │
│                   (~745MB each)                                  │
│                                                                  │
...
└──────────────────────────────┬──────────────────────────────────┘
                               │
┌──────────────────────────────▼──────────────────────────────────┐
│         Raspberry Pi 5 — ARM Cortex-A76 @ 2.4GHz (8GB)         │
│                                                                  │
│  ┌─────────────┐    ┌──────────────┐    ┌──────────────────┐    │
│  │  monitor.py  │    │  policy.py   │    │   hot_swap.py    │    │
│  │             │    │              │    │                  │    │
│  │ CPU temp    │───►│ Stress score │───►│ Active  Standby  │    │
│  │ RAM usage   │    │ (0 to 100)   │    │ :8080   :8081    │    │
│  │ tok/s       │    │ decide()     │    │  Q5  ↔   Q3      │    │
│  └─────────────┘    └──────────────┘    └──────────────────┘    │
│         │                                        │               │
│  ┌─────────────┐    ┌──────────────┐             │               │
